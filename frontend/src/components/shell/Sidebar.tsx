...
export default function Sidebar() {
  return (
    <aside className="ui-chrome flex h-full w-60 shrink-0 flex-col justify-between border-r border-black/5 bg-white p-4">
      ...
      {/* Bottom Section: AI-Powered Research Card */}
      <div className="rounded-2xl border border-brand bg-brand p-4">
        {/* Brain Badge Icon */}
        ...
        <p className="mt-1 text-xs leading-relaxed text-white/80">
          Get comprehensive insights from trusted sources with the power of AI.
        </p>
      </div>
    </aside>
  )
